...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib"); SEARCH_DIR("=/lib/arm-linux-gnueabihf"); SEARCH_DIR("=/usr/lib/arm-linux-gnueabihf"); SEARCH_DIR("=/lib/armv6k-linux-gnueabi"); SEARCH_DIR("=/usr/lib/armv6k-linux-gnueabi"); SEARCH_DIR("=/lib/armv7a-linux-gnueabihf"); SEARCH_DIR("=/usr/lib/armv7a-linux-gnueabihf"); SEARCH_DIR("=/lib/armv7a-linux-gnueabi"); SEARCH_DIR("=/usr/lib/armv7a-linux-gnueabi");
SECTIONS
{
